...
foreach(dep IN ITEMS Threads;OpenMP;X11;OpenGL)
    find_dependency(${dep})
endforeach()

include("${CMAKE_CURRENT_LIST_DIR}/Open3DTargets.cmake")

foreach(dep IN ITEMS Open3D::3rdparty_glew;Open3D::3rdparty_glfw;Open3D::3rdparty_fmt;Open3D::3rdparty_opengl)
    if(TARGET ${dep})
